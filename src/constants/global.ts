...
export const RAYDIUM_ADAPTOR_PROGRAM_ID =
  "A5a3Xo2JaKbXNShSHHP4Fe1LxcxNuCZs97gy3FJMSzkM";

export const INITIALIZE_CLMM_STRATEGY_DISCRIMINATOR = [
  14, 125, 156, 245, 156, 48, 227, 111,
];

export const DISCRIMINATOR = {
  OPEN_CLMM_POSITION: [14, 125, 156, 245, 156, 48, 227, 111],
  INCREASE_CLMM_LIQUIDITY: [59, 247, 201, 51, 201, 126, 104, 251],
  DECREASE_CLMM_LIQUIDITY: [29, 230, 124, 147, 3, 1, 171, 123],
};
